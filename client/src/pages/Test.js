...
class Test extends Component {
  ...
  checkAnswer = (userAnswer, correctAnswer, id) => {
    ...
    if (userAnswer.toLowerCase() === correctAnswer.toLowerCase()) {
      ...
      if (this.state.correct + 1 === this.state.allQuestions.length) {
        this.setState({
          allQuestions: tempState.allQuestions,
      ...
      this.setState({
        allQuestions: temp2State.allQuestions,
  ...
  restartGame = () => {
    API.getUser(this.context.currentId).then(res =>
      this.setState({
